          ...
          "trims": {
            ...
            "프레스티지": {
              ...
              "options": [
                ...
                "디 올 뉴 팰리세이드·원격 스마트 주차 보조",
                "디 올 뉴 팰리세이드·플래티넘",
                "디 올 뉴 팰리세이드·듀얼 와이드 선루프",
                "디 올 뉴 팰리세이드·빌트인 캠 2 Plus, 증강현실 내비게이션"
              ]
            },
            "캘리그래피": {
...
const optionLibrary = {
  ...
  "디 올 뉴 팰리세이드·빌트인 캠 2 Plus, 증강현실 내비게이션": {
    "price": "",
    "image": "images/options/hyundai/팰리세이드/빌트인 캠 2 Plus, 증강현실 내비게이션.avif",
    "desc": ""
  },
  "디 올 뉴 팰리세이드·프리뷰 전자제어 서스펜션": {
    "price": "1,230,000원",
    "image": "images/options/hyundai/팰리세이드/프리뷰 전자제어 서스펜션.avif",
    "desc": "21인치 캘리그래피 전용 알로이 휠 & 피렐리 타이어, 프리뷰 전자제어 서스펜션"
  },
  "디 올 뉴 팰리세이드·H Genuine Accessories 라이프스타일(7인승)": {
    "price": "",
    "image": "images/options/hyundai/팰리세이드/H Genuine Accessories 라이프스타일(7인승).avif",
    "desc": ""
  },
  "디 올 뉴 팰리세이드·듀얼 와이드 선루프": {
    "price": "850,000원",
    "image": "images/options/hyundai/팰리세이드/듀얼 와이드 선루프.avif",
    "desc": ""
  },
  "디 올 뉴 팰리세이드·현대 스마트센스": {
    "price": "690,000원",
    "image": "images/options/hyundai/팰리세이드/현대 스마트센스.avif",
    "desc": "후측방 충돌 경고(주행), 후측방 충돌방지 보조(전진 출차), 후방 교차 충돌방지 보조, 안전 하차 경고"
  },
  "디 올 뉴 팰리세이드·컴포트": {
    "price": "1,330,000원",
    "image": "images/options/hyundai/팰리세이드/컴포트.avif",
    "desc": "천연가죽 시트, 전동식 틸트 & 텔레스코픽 스티어링 휠, 운전석 전동시트(4way 럼버서포트, 자세 메모리 시스템), 동승석 전동시트(럼버서포트, 워크인 디바이스), \n발수 적용 1열 유리, 스마트 파워 테일게이트"
  },
  "디 올 뉴 팰리세이드·H Genuine Accessories 라이프스타일(9인승)": {
    "price": "",
    "image": "images/options/hyundai/팰리세이드/H Genuine Accessories 라이프스타일(9인승).avif",
    "desc": ""
  },
  "디 올 뉴 팰리세이드·컴포트 플러스(9인승)": {
    "price": "1,850,000원",
  ...
  "디 올 뉴 팰리세이드·플래티넘": {
    "price": "1,710,000원",
    "image": "images/options/hyundai/팰리세이드/플래티넘.avif",
    "desc": "BOSE 프리미엄 사운드(14스피커, 외장앰프 포함), 헤드업 디스플레이, 디지털 키 2, 다이내믹 웰컴/에스코트 라이트(1종)"
  },
  "디 올 뉴 팰리세이드·원격 스마트 주차 보조": {
    "price": "660,000원",
    "image": "images/options/hyundai/팰리세이드/원격 스마트 주차 보조.avif",
    "desc": ""
  },
  "디 올 뉴 팰리세이드·2열 다이내믹 바디케어 시트": {
    "price": "800,000원",
  ...
  "디 올 뉴 팰리세이드·H Genuine Accessories 라이프스타일(HEV)": {
    "price": "",
    "image": "images/options/hyundai/팰리세이드/H Genuine Accessories 라이프스타일(HEV).avif",
    "desc": ""
  },
  "인포테인먼트 내비Ⅱ": {
    "price": "1,060,000원",
